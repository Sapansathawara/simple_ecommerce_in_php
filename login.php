                        ...
                        <form id="register-form" action="#" method="post">
                            ...
                            <div class="single-contact-form">
                                <div class="contact-box name">
                                    ...
                                    <button type="button" class="fv-btn email_sent_otp height_60px" onclick="email_sent_otp()">Sent OTP</button>

                                    <input type="text" id="email_otp" placeholder="OTP*" class="email_verify_otp" style="width:45%">
                            ...
                            <!-- <div class="single-contact-form">
                                <div class="contact-box name">
                                    ...
                                    <button type="button" class="fv-btn mobile_sent_otp height_60px" onclick="mobile_sent_otp()">Sent OTP</button>

                                    <input type="text" id="mobile_otp" placeholder="OTP*" class="mobile_verify_otp" style="width:45%">
            ...
            jQuery.ajax({
                ...
                success: function(result) {
                    if (result == 'done') {
                        ...
                        jQuery('#email_otp_result').html('Email ID Verify');
            ...
            jQuery.ajax({
                ...
                success: function(result) {
                    if (result == 'done') {
                        ...
                        jQuery('#mobile_otp_result').html('Mobile Number Verify');
