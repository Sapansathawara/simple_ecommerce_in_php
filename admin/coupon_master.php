            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="box-title"><a href="manage_coupon_master.php">Add Coupon</a> </h4>
                    </div>
                    <div class="card-body--">
                                    ...
                                    while ($row = mysqli_fetch_assoc($res)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                echo "<span class='badge badge-edit'><a href='manage_coupon_master.php?id=" . $row['id'] . "'>Edit</a></span>&nbsp";
