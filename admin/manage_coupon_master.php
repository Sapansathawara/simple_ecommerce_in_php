...
isAdmin();
$coupon_code = $coupon_value = $coupon_type = $cart_min_value = '';
$msg = '';
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body card-block">
                            <div class="form-group">
                                <label for="name" class="form-control-label">Coupon Code</label>
                                <input type="text" name="coupon_code" value="<?php echo $coupon_code ?>" placeholder="Enter coupon code" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="name" class="form-control-label">Coupon Value</label>
                                <input type="text" name="coupon_value" value="<?php echo $coupon_value ?>" placeholder="Enter coupon value" class="form-control" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="name" class="form-control-label">Cart Min Value</label>
                                <input type="number" name="cart_min_value" value="<?php echo $cart_min_value ?>" placeholder="Enter cart min value" class="form-control" required>
                            </div>
