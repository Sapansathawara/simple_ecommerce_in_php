                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($res)) { ?>
                                        <tr>
                                            ...
                                            <td><?php
                                                echo "<a target='_blank' href='" . BANNER_SITE_PATH . $row['image'] . "'><img width='100px'; src='" . BANNER_SITE_PATH . $row['image'] . "'></a>";
                                                ?></td>
                                            <td>
                                                <?php
                                                if ($row['status'] == 1) {
                                                ...
                                                echo "<span class='badge badge-edit'><a href='manage_banner.php?id=" . $row['id'] . "'>Edit</a></span>&nbsp";
