...
$sql = "select sc.*, c.categories AS category_name from sub_categories as sc inner join categories as c on c.id=sc.categories_id order by sc.sub_categories asc";
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="box-title"><a href="manage_sub_categories.php">Add Sub-Categories</a> </h4>
                    </div>
                    <div class="card-body--">
